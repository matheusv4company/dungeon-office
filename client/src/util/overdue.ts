...
// hora. O committedDue (prazo congelado anti-gaming) fica SÓ no score do servidor, nunca no
// que o usuário enxerga (o 1o param é mantido por compat de assinatura, mas não entra no display).
 ...
 */
export function daysToDue(_committedDue: number, due: string, col: string, blockedMs = 0): number | null {
